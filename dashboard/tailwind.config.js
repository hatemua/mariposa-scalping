  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        mono: ['JetBrains Mono', 'Fira Code', 'Monaco', 'Cascadia Code', 'Menlo', 'monospace'],
      ...
      boxShadow: {
        ...
        'hard': '0 10px 40px -10px rgba(0, 0, 0, 0.2), 0 2px 5px -2px rgba(0, 0, 0, 0.1)',
        ...
        'dark-hard': '0 10px 40px -10px rgba(0, 0, 0, 0.6), 0 2px 5px -2px rgba(0, 0, 0, 0.4)',
      },
      backdropBlur: {
        'xs': '2px',
        '4xl': '72px',
